...
export const LoginVendorAccountFrom = () => {
  const {
    register,
    handleSubmit,
    errors,
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <Input
            id="email"
            type="email"
            placeholder="student.name@company.com"
        ...
        <div className="text-center">
          <NavLink to={'/forgot-password'} className="text-sm text-primary font-medium hover:underline">
        ...
        <p className="text-center text-sm text-muted-foreground">
          ...
          <NavLink to={'/signinvendor'} className="text-primary font-medium hover:underline">
            Sign Up
          </NavLink>
        </p>
      </form>
