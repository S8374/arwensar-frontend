...
import { Check, AlertCircle, Loader2, Download, Upload } from "lucide-react";
...
export default function ImportSuppliersModal({
  ...
  const downloadTemplate = () => {
    const templateData = [
      {
        ...
        criticality: "HIGH",
        contractStartDate: "13-12-2025", // Use DD-MM-YYYY format in template
        contractEndDate: "30-12-2025",  // Use DD-MM-YYYY format in template
        // Note: Remove any extra spaces in dates
      }
    ];
    ...
    const wscols = [
      ...
      { wch: 15 }, // category
      { wch: 10 }, // criticality
      { wch: 15 }, // contractStartDate
      { wch: 15 }, // contractEndDate
    ];
    ws['!cols'] = wscols;
    ...
    const instructionData = [
      ...
      [],
      ["1. Date Format", "Use DD-MM-YYYY format (e.g., 13-12-2025)"],
      ["2. Criticality", "Must be one of: LOW, MEDIUM, HIGH"],
      ["3. Email", "Must be valid email format"],
      ["4. Required Fields", "All fields are required"],
      [],
      ["Example Data:"],
      ["name", "contactPerson", "email", "phone", "category", "criticality", "contractStartDate", "contractEndDate"],
      ["Acme Corp", "John Doe", "john@acme.com", "+1234567890", "IT Security", "HIGH", "13-12-2025", "30-12-2025"]
    ];
