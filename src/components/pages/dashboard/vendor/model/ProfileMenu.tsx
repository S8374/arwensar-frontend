...
import { LogOut, Settings, Shield, Crown, Mail } from "lucide-react";
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent
        align="end"
        sideOffset={12}
        className="w-80 rounded-2xl border bg-card/95 backdrop-blur-xl shadow-2xl p-4"
      >
        {/* Header */}
        ...
        {userRole === "VENDOR" && (
          <DropdownMenuItem className="rounded-xl cursor-pointer">
            <NavLink to="/vendor/analytics" className="flex items-center">
        ...
        {userRole === "SUPPLYER" && (
          <DropdownMenuItem className="rounded-xl cursor-pointer">
            <NavLink to="/supplier/analytics" className="flex items-center">
              <Settings className="w-4 h-4 mr-3 text-primary" />
