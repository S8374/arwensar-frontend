          ...
          <div className="space-y-6">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <Progress value={businessScore} className="h-3" indicatorClassName="bg-blue-600" />
              </div>
              ...
              <div>
                ...
                <Progress value={integrityScore} className="h-3" indicatorClassName="bg-green-600" />
              </div>
              ...
              <div>
                ...
                <Progress value={availabilityScore} className="h-3" indicatorClassName="bg-purple-600" />
              </div>
            </div>
