...
export default function Profile() {
 const { data: userData } = useUserInfoQuery(undefined);
  ...
  const profileData = {
    firstName: userData?.data?.vendor?.firstName || "",
    lastName: userData?.data?.vendor?.lastName || "",
    email: userData?.data?.email || "", // This comes from user table
    companyName: userData?.data?.vendor?.companyName || "", // Changed from 'company'
    contactNumber: userData?.data?.vendor?.contactNumber || "", // Changed from 'phone'
    industryType: userData?.data?.vendor?.industryType || "",
  };
  const {
    register,
    handleSubmit,
