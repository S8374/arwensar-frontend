...
export default function VendorReportsPage() {
    ...
    // Fetch data
    const { data: reportsData, refetch: refetchReports, isLoading: reportsLoading } = useGetReportsQuery();
    ...
    const [getReportDocument, { isLoading: downloading }] = useGetReportDocumentMutation();
    ...
    const storageUsage = stats?.storageUsage || { total: 0, average: 0 };
