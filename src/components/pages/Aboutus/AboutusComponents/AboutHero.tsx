      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12 xl:gap-16">
          ...
          <div className="flex-1 flex flex-col justify-center text-center lg:text-left max-w-4xl mx-auto lg:mx-0">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight sm:leading-tight lg:leading-tight">
            ...
            <div className="mt-6 sm:mt-8 flex justify-center lg:justify-start">
              <Button
                className="px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold bg-background text-foreground rounded-lg border-2 border-foreground hover:bg-background/90 transition-all duration-200 min-h-[48px] sm:min-h-[56px]"
              >
                Suspendisse
              </Button>
            </div>
