...
export default function DemoHero() {
  return (
    <section className="bg-background text-foreground pt-28 md:pt-40 lg:pt-40 mb-8 ">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12 xl:gap-16">
          ...
          <div className="flex-1 flex flex-col justify-center text-center lg:text-left max-w-4xl mx-auto lg:mx-0">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight sm:leading-tight lg:leading-tight">
